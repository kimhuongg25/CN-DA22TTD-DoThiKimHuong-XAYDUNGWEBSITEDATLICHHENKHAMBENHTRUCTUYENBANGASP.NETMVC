...
namespace WebAppYte.Areas.Admin.Controllers
{
    public class NguoiDungsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDNguoiDung,HoTen,Email,DienThoai,TaiKhoan,MatKhau,IDGioiTinh,DiaChiCuThe,SoCMND,IDHuyen,ThongTinKhac")] NguoiDung nguoiDung)
        {
