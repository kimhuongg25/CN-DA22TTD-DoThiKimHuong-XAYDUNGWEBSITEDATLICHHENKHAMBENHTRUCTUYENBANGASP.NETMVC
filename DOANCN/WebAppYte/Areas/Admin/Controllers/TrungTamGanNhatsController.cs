...
namespace WebAppYte.Areas.Admin.Controllers
{
    public class TrungTamGanNhatsController : Controller
    {
        ...
        {
            var trungTamGanNhats = db.TrungTamGanNhats.Include(t => t.Huyen);
        ...
        [ValidateInput(false)]
        public ActionResult Create([Bind(Include = "IDTrungTam,TenTrungTam,Mota,IDHuyen")] TrungTamGanNhat trungTamGanNhat)
        {
            ...
            ViewBag.IDHuyen = new SelectList(db.Huyens, "IDHuyen", "TenHuyen", trungTamGanNhat.IDHuyen);
            return View(trungTamGanNhat);
        }
        ...
        [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Edit([Bind(Include = "IDTrungTam,TenTrungTam,Mota,IDHuyen")] TrungTamGanNhat trungTamGanNhat)
        {
            if (ModelState.IsValid)
            {
